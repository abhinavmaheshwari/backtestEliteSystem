...
def fetch_watchlist_data(
    ...
    for i in range(0, total, batch_size):
        ...
        try:
            ...
            if len(batch) == 1:
                # Single ticker: yfinance returns a plain DataFrame
                sym = batch[0]
                ...
                # Multi-ticker: yfinance returns MultiIndex columns (OHLCV × Ticker)
                for sym in batch:
                    try:
                        # xs extracts one ticker's slice across all OHLCV columns
